...
public class YandexWeatherProvider implements WeatherProvider {
    ...
    private final String PROPERTIES = "./src/main/resources/lesson7.homework/yandex-werther.properties";
    ...
    public void getWeather(City city, Period period) throws IOException {
        ...
        Request request = new Request.Builder()
                .addHeader("X-Yandex-API-Key", properties.getProperties().getProperty("X-Yandex-API-Key"))
        ...
        weatherResponse.printWeather(jsonResponse, period);
    }

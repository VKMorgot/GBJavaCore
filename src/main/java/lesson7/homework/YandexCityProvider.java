...
public class YandexCityProvider implements CityProvider {
    ...
    // работа с конфигом
    private final String PROPERTIES = "./src/main/resources/lesson7.homework/yandex-geo.properties";
    ...
    public void getCoordinates(City city) throws IOException {
        ...
        HttpUrl url = new HttpUrl.Builder()
                ...
                .addQueryParameter("apikey", properties.getProperties().getProperty("API-Key"))
